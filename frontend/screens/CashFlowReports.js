...
const CashFlowReports = ({ route }) => {
    ...
    const fetchExistingReports = async () => {
        ...
        try {
            const response = await axios.get('http://localhost:3000/reports/reports', {
                params: { report_type: 'cash-flow', place: place }
            });
    ...
    const handleCreateReport = async () => {
        ...
        try {
            const response = await axios.get('http://localhost:3000/reports/cash-flow-report', {
            ...
            <View style={styles.listContainer}>
                ...
                {!loading && (
                    <FlatList
                        ...
                        ListEmptyComponent={<Text style={styles.infoText}>Belum ada laporan yang dibuat untuk periode ini.</Text>}
                    />
                )}
            </View>
        </View>
